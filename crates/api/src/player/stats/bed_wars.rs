...
#[cfg(feature = "canvas")]
mod canvas {
	use super::{HotbarItem, ShopItem};

	use crate::canvas::shape;
	use crate::skyblock::materials::MATERIALS;
	use image::Image;
...
pub struct BedWars {
	...
	#[serde(flatten)]
	#[cfg_attr(feature = "game", game(mode(hypixel = "BEDWARS_EIGHT_ONE")))]
	pub solo: Solo,
	#[serde(flatten)]
	#[cfg_attr(feature = "game", game(mode(hypixel = "BEDWARS_EIGHT_TWO")))]
	pub double: Double,
	#[serde(flatten)]
	#[cfg_attr(feature = "game", game(mode(hypixel = "BEDWARS_FOUR_THREE")))]
	pub three: Three,
	#[serde(flatten)]
	#[cfg_attr(feature = "game", game(mode(hypixel = "BEDWARS_FOUR_FOUR")))]
	pub four: Four,
	#[serde(flatten)]
	#[cfg_attr(
		feature = "game",
	...
	#[serde(flatten)]
	#[cfg_attr(feature = "game", game(mode(hypixel = "BEDWARS_CASTLE", skip_overall)))]
	pub castle: Castle,
	#[serde(flatten)]
	#[cfg_attr(
		feature = "game",
...
#[derive(serde::Deserialize, bincode::Decode, bincode::Encode, Default, Debug)]
#[serde(default)]
