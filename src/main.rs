...
async fn main() {
	...
	let mut commands = vec![
		...
		commands::ser::ser(),
		commands::sky_wars::skywars(),
		commands::smash_heroes::smash(),
		commands::speed_uhc::speeduhc(),
		commands::tnt_games::tntgames(),
		commands::turbo_kart_racers::turkokartracers(),
		commands::uhc::uhc(),
		commands::unlink::unlink(),
		commands::vampire_z::vampirez(),
		commands::walls::walls(),
		commands::warlords::warlords(),
		commands::wool_wars::woolwars(),
	];
