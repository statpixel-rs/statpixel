...
showing-statistics = <a:clock:1113624864272683060> Показване на статистиката от {$from} до {$to}.
...
showing-comparison = <a:clock:1113624864272683060> Показване на статистиката на **`{$from}`** спрямо **`{$to}`**.
...
error-leaderboard-player-not-found = Предоставеният играч не е намерен в първите или последните 15 000 позиции в класирането.
...
tip-display-compact = <:knowledge_book:1117179094556233828> Промяна на формата на екрана с </display:1113624864272683066>.
tip-display-font = <:knowledge_book:1117179094556233828> Промяна на шрифта на екрана с </display:1113624864272683066>.
tip-display-embed = <:knowledge_book:1117179094556233828> Промяна на формата на екрана с </display:1113624864272683066>.
tip-compare = <:knowledge_book:1117179094556233828> Сравнете двама играчи с </bedwars compare:1113624864272683060>.
...
Compact = Компактно
Text = Текст
CompactFaithful = Компактно (Faithful 32x Шрифт)
CompactRoboto = Компактно (Roboto Шрифт)
...
Dropper = Капачка
PixelParty = Пиксел Парти

flawless-games = Безупречни Игри
fails = Грешки
fastest-game = Най-Бърза Игра
power-ups = Усилвания
rounds-completed = Завършени Рундове
highest-round = Най-Висок Рунд
...
arcade-project = проект
  ...
  .mode-description = Режимът на Arcade, който да се покаже
  .statistic = статистика
  .statistic-description = Статистиката на Arcade, която да се прогнозира
  .value = стойност
...
arena-project = проект
  ...
  .mode-description = Режимът на Arena, който да се покаже
  .statistic = статистика
  .statistic-description = Статистиката на Arena, която да се прогнозира
  .value = стойност
  .value-description = Стойността на статистиката, която да се прогнозира
...
bedwars-project = проект
  ...
  .mode-description = Режимът на Bed Wars, който да се покаже
  .statistic = статистика
  .statistic-description = Статистиката на Bed Wars, която да се прогнозира
  .value = стойност
  .value-description = Стойността на статистиката, която да се прогнозира
...
blitz-project = проект
  ...
  .mode-description = Режим на Blitz Survival Games за преглед
  .statistic = статистика
  .statistic-description = Статистика на Blitz Survival Games за проекция
  .value = стойност
...
buildbattle-project = проект
  ...
  .mode-description = Режим на Build Battle за преглед
  .statistic = статистика
  .statistic-description = Статистика на Build Battle за проекция
  .value = стойност
  .value-description = Стойността на статистиката, която да се прожектира
...
copsandcrims-project = проект
  ...
  .mode-description = Режим на Cops and Crims за преглед
  .statistic = статистика
  .statistic-description = Статистика на Cops and Crims за проекция
  .value = стойност
  .value-description = Стойността на статистиката, която да се прожектира
...
duels-project = проекция
  ...
  .mode-description = Режимът на Duels за преглед
  .statistic = статистика
  .statistic-description = Статистиката на Duels за проекция
  .value = стойност
...
megawalls-project = проекция
  ...
  .mode-description = Режимът на Mega Walls за преглед
  .statistic = статистика
  .statistic-description = Статистиката на Mega Walls за проекция
  .value = стойност
  .value-description = Стойността на статистиката, която да се проектира
...
murdermystery-project = проект
  ...
  .mode-description = Режимът на Murder Mystery за преглед
  .statistic = статистика
  .statistic-description = Статистика на Murder Mystery за прожекция
  .value = стойност
  .value-description = Стойността на статистиката, която да се проектира
...
paintball-project = проект
  ...
  .mode-description = Режимът на Paintball за преглед
  .statistic = статистика
  .statistic-description = Статистика на Paintball за прожекция
  .value = стойност
  .value-description = Стойността на статистиката, която да се проектира
...
pit-project = проект
  ...
  .mode-description = Режимът на The Pit за преглед
  .statistic = статистика
  .statistic-description = Статистика на The Pit за прожекция
  .value = стойност
  .value-description = Стойността на статистиката, която да се проектира
...
quake-project = проект
  ...
  .statistic = статистика
  .statistic-description = Quakecraft статистика за проекция
  .value = стойност
...
skywars-project = проект
  ...
  .mode-description = SkyWars режим за преглед
  .statistic = статистика
  .statistic-description = SkyWars статистика за проекция
  .value = стойност
  .value-description = Стойността на статистиката за проекция
...
smash-project = проект
  ...
  .mode-description = Smash Heroes режим за преглед
  .statistic = статистика
  .statistic-description = Smash Heroes статистика за проекция
  .value = стойност
  .value-description = Стойността на статистиката за проекция
...
speeduhc-project = проект
  ...
  .statistic = статистика
  .statistic-description = Статистиката на SpeedUHC, която да се прожектира
  .value = стойност
  .value-description = Стойността на статистиката, която да се прожектира
...
tntgames-project = проект
  ...
  .mode-description = Режимът на TNT Games за преглед
  .statistic = статистика
  .statistic-description = Статистиката на TNT Games, която да се прожектира
  .value = стойност
  .value-description = Стойността на статистиката, която да се прожектира
...
laps-completed = Завършени обиколки
...
turbokartracers-project = проект
  ...
  .mode-description = Режимът на Turbo Kart Racers за преглед
  .statistic = статистика
  .statistic-description = Статистиката на Turbo Kart Racers, която да се прожектира
  .value = стойност
  .value-description = Стойността на статистиката, която да се прожектира
...
uhc-project = проект
  ...
  .mode-description = Режим на UHC Champions за преглед
  .statistic = статистика
  .statistic-description = Статистика на UHC Champions за прогнозиране
  .value = стойност
...
vampirez-project = проект
  ...
  .mode-description = Режим на VampireZ за преглед
  .statistic = статистика
  .statistic-description = Статистика на VampireZ за прогнозиране
  .value = стойност
  .value-description = Стойността на статистиката за прогнозиране
...
walls-project = проект
  ...
  .mode-description = Режим на The Walls за преглед
  .statistic = статистика
  .statistic-description = Статистика на The Walls за прогнозиране
  .value = стойност
  .value-description = Стойността на статистиката за прогнозиране
...
warlords-project = проект
  ...
  .mode-description = Режимът на Warlords за преглед
  .statistic = статистика
  .statistic-description = Статистиката на Warlords, която да се проектира
  .value = стойност
  .value-description = Стойността на статистиката, която да се проектира
...
woolwars-project = проект
  ...
  .mode-description = Режимът на Wool Wars за преглед
  .statistic = статистика
  .statistic-description = Статистиката на Wool Wars, която да се проектира
  .value = стойност
  .value-description = Стойността на статистиката, която да се проектира
...
showing-statistics-at = <a:clock:1113624864272683060> Показване на статистиката от {$at}.
...
session-created = Сесията с идентификационен номер **`{$id}`** беше създадена за **`{$username}`**.
  ...
  Или използвайте командата за сесия, за да видите доколко е продвинат играчът след като тя започне: </bedwars session:1113624864272683060>
  Обърнете внимание, че тази команда е бърз път за </bedwars compare:1113624864272683060>!
...
fishing-general = общи
  .description = Преглед на статистиката за риболов
  .player = играч
  .player-description = Играч или сесия в Minecraft
  .mode = режим
  .mode-description = Режим на риболов

fishing-from = от
  .description = Преглед на развитието на статистиката за риболов след определено време
  .player = играч
  .player-description = Играч или сесия в Minecraft
  .mode = режим
  .mode-description = Режим на риболов за преглед
  .time = време
  .time-description = Времеви интервал (1ч 12м 5с)

fishing-history = история
  .description = Преглед на развитието на статистиката за риболов във времето
  .player = играч
  .player-description = Играч или сесия в Minecraft
  .mode = режим
  .mode-description = Режим на риболов

fishing-project = проекция
  .description = Прожекция на статистиката за риболов в бъдещето
  .player = играч
  .player-description = Играч или сесия в Minecraft
  .mode = режим
  .mode-description = Режим на риболов за преглед
  .statistic = статистика
  .statistic-description = Статистика за риболов за проекция
  .value = стойност
  .value-description = Стойност на статистиката за проекция

fishing-daily = дневно
  .description = Преглед на развитието на статистиката за риболов през последния ден
  .player = играч
  .player-description = Играч или сесия в Minecraft
  .mode = режим
  .mode-description = Режим на риболов

fishing-weekly = седмично
  .description = Преглед на развитието на статистиката за риболов през последната седмица
  .player = играч
  .player-description = Играч или сесия в Minecraft
  .mode = режим
  .mode-description = Режим на риболов

fishing-monthly = месечно
  .description = Преглед на развитието на статистиката за риболов през последния месец
  .player = играч
  .player-description = Играч или сесия в Minecraft
  .mode = режим
  .mode-description = Режим на риболов

fishing-session = сесия
  .description = Покажи развитието на статистиката за риболов на играч от началото на сесията
  .session = сесия
  .session-description = Идентификатор на сесия
  .mode = режим
  .mode-description = Режим на риболов

fishing-at = в
  .description = Покажи статистиката за риболов на играч в определен момент във времето
  .player = играч
  .player-description = Играч или сесия в Minecraft
  .time = време
  .time-description = Времеви интервал (1ч 12м 5с)
...
fishing-compare = сравни
  .description = Сравни статистиката за риболов на двама играчи
  .from = от
  .from-description = Играч в Minecraft
  .to = до
  .to-description = Играч в Minecraft за сравнение
...
parkour = паркур
  .description = Преглед на статистиката за паркур
  .player = играч
  .player-description = Играч в Minecraft или сесия
