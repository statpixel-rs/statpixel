...
showing-statistics = <a:clock:1113624864272683060> แสดงการเปลี่ยนแปลงสถิติจาก {$from} ถึง {$to}
...
showing-comparison = <a:clock:1113624864272683060> แสดงสถิติของ **`{$from}`** กับ **`{$to}`**
...
error-leaderboard-player-not-found = ไม่พบผู้เล่นที่ให้มาในตำแหน่งแรกหรือตำแหน่งสุดท้ายของตารางคะแนนสูงสุด
...
tip-history = <:knowledge_book:1117179094556233828> ดูกราฟประวัติของสถิติของคุณด้วยคำสั่ง </bedwars history:1113624864272683060>
tip-from = <:knowledge_book:1117179094556233828> ดูการเปลี่ยนแปลงสถิติจากวันที่เฉพาะด้วยคำสั่ง </bedwars from:1113624864272683060>
...
tip-snapshot = <:knowledge_book:1117179094556233828> เข้าถึงสถิติประจำวันของคุณด้วยคำสั่ง </bedwars daily:1113624864272683060>
...
tip-project = <:knowledge_book:1117179094556233828> ดูประมาณการของข้อมูลทั้งหมดของคุณด้วยคำสั่ง </bedwars project:1113624864272683060>
...
tip-boost = <:knowledge_book:1117179094556233828> เพิ่มพลังให้กับกิลด์ด้วยคำสั่ง </boost:1132443666997321809>
tip-track = <:knowledge_book:1117179094556233828> ติดตามผู้เล่นด้วยคำสั่ง </track:1132443666997321810>
...
tip-display-compact = <:knowledge_book:1117179094556233828> เปลี่ยนรูปแบบการแสดงผลของคุณเป็นแบบสั้นด้วยคำสั่ง </display:1113624864272683066>.
tip-display-font = <:knowledge_book:1117179094556233828> เปลี่ยนรูปแบบการแสดงผลของคุณด้วยคำสั่ง </display:1113624864272683066>.
tip-display-embed = <:knowledge_book:1117179094556233828> เปลี่ยนรูปแบบการแสดงผลของคุณเป็นแบบฝังด้วยคำสั่ง </display:1113624864272683066>.
tip-compare = <:knowledge_book:1117179094556233828> เปรียบเทียบผู้เล่นสองคนด้วยคำสั่ง </bedwars compare:1113624864272683060>.
...
track-success-title = กำลังติดตาม {$name}
...
help-snapshot-description = สแน็ปช็อตเป็นวิธีการดูการเปลี่ยนแปลงในสถิติของคุณตามเวลา มีคำสั่งประโยชน์บางส่วนที่ช่วยทำให้ชีวิตของคุณง่ายขึ้น: </bedwars daily:1113624864272683060>, </bedwars weekly:1113624864272683060> และ </bedwars monthly:1113624864272683060> นอกจากนี้ยังใช้งานได้สำหรับกิลด์ของคุณด้วย ลองดู </guild daily:1113624864524357706>!

  หากคุณต้องการดูช่วงเวลาที่แน่นอน ลอง </bedwars from:1113624864272683060>.

help-history = ประวัติ <a:clock:1113624864272683060>
help-history-description = หากต้องการดูกราฟว่าสถิติเฉลี่ยแต่ละประเภทเปลี่ยนแปลงไปอย่างไรตามเวลา ลองดู </network history:1113624864524357714>.
...
Compact = ภาพย่อ
Text = ข้อความ
CompactFaithful = ภาพย่อ (แบบอักษร Faithful 32x)
CompactRoboto = ภาพย่อ (แบบอักษร Roboto)
...
linking-failed-username-description = ชื่อผู้เล่น **`{$name}`** ไม่ใช่บัญชี Minecraft
...
Dropper = ดรอปเปอร์
PixelParty = พิกเซลปาร์ตี้

flawless-games = เกมที่ไม่มีข้อบกพร่อง
fails = ล้มเหลว
fastest-game = เกมที่เร็วที่สุด
power-ups = พลังงาน
rounds-completed = รอบที่เสร็จสมบูรณ์
highest-round = รอบสูงสุด
...
arcade-from = จาก
  ...
  .mode-description = โหมด Arcade ที่ต้องการดู
  .time = เวลา
  .time-description = จำนวนเวลาที่ต้องการย้อนกลับ (1h 12m 5s)
...
blitz-from = ตั้งแต่
  ...
  .mode-description = โหมดของ Blitz Survival Games ที่ต้องการดู
  .time = เวลา
  .time-description = จำนวนเวลาที่ต้องการให้ย้อนกลับ (1h 12m 5s)
...
paintball-from = ตั้งแต่
  ...
  .mode-description = โหมด Paintball ที่ต้องการดู
  .time = เวลา
  .time-description = ระยะเวลาที่ต้องการย้อนกลับ (1h 12m 5s)
...
SoloTournament = โหมดการแข่งขันเดี่ยว
...
showing-statistics-at = <a:clock:1113624864272683060> แสดงสถิติจาก {$at}
showing-guild-statistics-at = แสดงสถิติกิลด์จาก {$at}

error-session-not-found = ไม่พบเซสชันด้วย ID ที่ระบุ
error-session-already-exists = เซสชันที่มีชื่อที่ระบุไว้ถูกสร้างไปแล้ว

session-deleted = เซสชันที่มี ID **`{$id}`** ถูกลบแล้ว
session-created-title = เซสชันถูกสร้าง
session-created = เซสชันที่มี ID **`{$id}`** ได้ถูกสร้างสำหรับ **`{$name}`**
  แทนที่ตำแหน่งของผู้เล่นใด ๆ ด้วย ID เซสชันเพื่อใช้ข้อมูลในคำสั่งใด ๆ

  ลองใช้ดู: </bedwars general:1113624864272683060>

  หรือใช้คำสั่งเซสชันเพื่อดูว่าผู้เล่นได้ก้าวหน้าไปถึงไหนตั้งแต่เริ่มต้น: </bedwars session:1113624864272683060>
  โปรดทราบว่าคำสั่งนี้เป็นทางลัดสำหรับ </bedwars compare:1113624864272683060>!
...
session-create = สร้าง
  ...
  .name = ชื่อ
  .name-description = ชื่อของเซสชัน
