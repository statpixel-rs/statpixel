...
help-general-description = StatPixel поддерживает каждую игру в сети Hypixel. Вы можете просматривать статистику для каждой игры, используя `/<game>`. Например, попробуйте </bedwars:1106761189226205186>!

help-display = Отображение <:spyglass:1110754818433228991>
help-display-description = Если у вас мобильное подключение или вы просто хотите сэкономить немного данных, вы можете получать ответы в разных форматах, например, текст или сжатые изображения, с помощью </display:1100232181504290887>.

help-link = Связывание <a:recovery_compass:1110755004463198218>
help-link-description = Ввод имени пользователя для каждой команды может стать утомительным. Чтобы сделать это проще, вы можете связать учетную запись без проверки с помощью </link:866348630600056875> и отвязать ее позже с помощью </unlink:1101304082817355807>.

help-snapshot = Снимки <:book_and_quill:1110754805724479569>
help-snapshot-description = Снимки - это способ просмотра изменений в ваших статистических данных со временем. Есть несколько вспомогательных команд, которые сделают вашу жизнь проще: </daily bedwars:1107131762062135366>, </weekly bedwars:1107131762062135368> и </monthly bedwars:1107131762062135367>. Они также работают для вашей гильдии, поэтому попробуйте </daily guild:1107131762062135366>!
  
  Если вы хотите просмотреть более конкретный диапазон, попробуйте </from bedwars:1111713108919070820>.

help-history = История <a:clock:1110754973794451557>
help-history-description = Чтобы просмотреть график того, как менялись конкретные статистические данные со временем, попробуйте </history network:1110774513970466896>.
