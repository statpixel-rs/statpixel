...
error-boost-limit-reached =
  Вы достигли максимального количества усилений {$limit}. Вы можете удалить усиление на панели инструментов: <https://statpixel.xyz/dashboard/boosts>.
...
boost-success-description =
  ...
  Чтобы удалить это усиление, перейдите на панель инструментов по адресу https://statpixel.xyz/dashboard/boosts.
...
track-success-description =
  ...
  Чтобы прекратить отслеживание, удалите его на панели инструментов по адресу https://statpixel.xyz/dashboard/tracking.
