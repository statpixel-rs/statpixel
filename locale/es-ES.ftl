...
error-snapshot-not-found = No se encontró una sesión perteneciente a **`{$name}`**.
...
error-player-snapshot-not-found = No se encontraron instantáneas para **`{$name}`**. Crea una con </bedwars daily:1113624864272683060>.
...
error-guild-track-limit-reached =
  ...
  Si tienes StatPixel+, potencia el gremio con </boost:1132443666997321809> para eliminar esta restricción o ve a <https://statpixel.xyz/plus>.
...
error-leaderboard-player-not-found = El jugador proporcionado no se encontró dentro de las primeras o últimas 15,000 posiciones de la tabla de clasificación.
...
tip-history = <:knowledge_book:1117179094556233828> Ver un gráfico histórico de tus estadísticas con </bedwars history:1113624864272683060>.
tip-from = <:knowledge_book:1117179094556233828> Ver el cambio en estadísticas desde una fecha específica con </bedwars from:1113624864272683060>.
...
tip-snapshot = <:knowledge_book:1117179094556233828> Accede a tus estadísticas diarias con </bedwars daily:1113624864272683060>.
...
tip-project = <:knowledge_book:1117179094556233828> Ver estimaciones de todos tus datos con </bedwars project:1113624864272683060>.
...
tip-boost = <:knowledge_book:1117179094556233828> Potenciar un gremio con </boost:1132443666997321809>.
tip-track = <:knowledge_book:1117179094556233828> Seguir a un jugador con </track:1132443666997321810>.
...
tip-display-embed = <:knowledge_book:1117179094556233828> Cambia el formato de visualización a embed con </display:1113624864272683066>.
...
help-snapshot-description = Las instantáneas son una forma de ver los cambios en tus estadísticas con el tiempo. Hay algunos comandos de utilidad para facilitar esto: </bedwars daily:1113624864272683060>, </bedwars weekly:1113624864272683060> y </bedwars monthly:1113624864272683060>. Estos también funcionan para tu hermandad, así que prueba </guild daily:1113624864524357706>!
...
Image = Imagen
ImageFaithful = Imagen (Fuente Faithful 32x)
ImageRoboto = Imagen (Fuente Roboto)
Compact = Compacto
Text = Texto
CompactFaithful = Compacto (Fuente Faithful 32x)
CompactRoboto = Compacto (Fuente Roboto)
...
Dropper = Cae
PixelParty = Fiesta de Píxeles

flawless-games = Juegos Perfectos
fails = Fallos
fastest-game = Juego Más Rápido
power-ups = Potenciadores
rounds-completed = Rondas Completadas
highest-round = Ronda Más Alta
...
arcade-project = proyección
  ...
  .mode-description = El modo de Arcade para ver
  .statistic = estadística
  .statistic-description = La estadística de Arcade a proyectar
  .value = valor
...
arena-project = proyección
  ...
  .mode-description = El modo de Arena para ver
  .statistic = estadística
  .statistic-description = La estadística de Arena a proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
bedwars-project = proyección
  ...
  .mode-description = El modo de Bed Wars para ver
  .statistic = estadística
  .statistic-description = La estadística de Bed Wars a proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
blitz-project = proyección
  ...
  .mode-description = El modo de Blitz Survival Games para ver
  .statistic = estadística
  .statistic-description = La estadística de Blitz Survival Games a proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
SoloPro = Solo Pro
GuessTheBuild = Adivina la Construcción
...
buildbattle-project = proyección
  ...
  .mode-description = El modo de Build Battle para ver
  .statistic = estadística
  .statistic-description = La estadística de Build Battle a proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
copsandcrims-project = proyección
  ...
  .mode-description = El modo de Cops and Crims para ver
  .statistic = estadística
  .statistic-description = La estadística de Cops and Crims a proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
duels-from = desde
  ...
  .mode-description = El modo de Duelos para ver
  .time = tiempo
  .time-description = La cantidad de tiempo hacia atrás (1h 12m 5s)
...
duels-project = proyección
  ...
  .mode-description = El modo de Duelos para ver
  .statistic = estadística
  .statistic-description = La estadística de Duelos para proyectar
  .value = valor
...
megawalls-project = proyección
  ...
  .mode-description = El modo de Mega Walls para ver
  .statistic = estadística
  .statistic-description = La estadística de Mega Walls para proyectar
  .value = valor
  .value-description = El valor de la estadística para proyectar
...
murdermystery-project = proyecto
  ...
  .statistic = estadística
  .statistic-description = La estadística del Misterio del Asesinato para proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
paintball-project = proyecto
  ...
  .mode-description = El modo Paintball para ver
  .statistic = estadística
  .statistic-description = La estadística de Paintball para proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
pit-project = proyecto
  ...
  .mode-description = El modo The Pit para ver
  .statistic = estadística
  .statistic-description = La estadística de The Pit para proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
quake-project = proyecto
  ...
  .statistic = estadística
  .statistic-description = La estadística de Quakecraft a proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
skywars-from = desde
  ...
  .mode-description = El modo de SkyWars a visualizar
  .time = tiempo
  .time-description = La cantidad de tiempo a retroceder (1h 12m 5s)
...
skywars-project = proyecto
  ...
  .mode-description = El modo de SkyWars a visualizar
  .statistic = estadística
  .statistic-description = La estadística de SkyWars a proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
smash-project = proyecto
  ...
  .mode-description = El modo de Smash Heroes a visualizar
  .statistic = estadística
  .statistic-description = La estadística de Smash Heroes a proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
speeduhc-project = proyecto
  ...
  .statistic = estadística
  .statistic-description = La estadística de SpeedUHC a proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
tntgames-project = proyecto
  ...
  .mode-description = El modo de TNT Games a ver
  .statistic = estadística
  .statistic-description = La estadística de TNT Games a proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
laps-completed = Vueltas Completadas
...
turbokartracers-project = proyecto
  ...
  .mode-description = El modo de Turbo Kart Racers a ver
  .statistic = estadística
  .statistic-description = La estadística de Turbo Kart Racers a proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
uhc-project = proyecto
  ...
  .mode-description = El modo de UHC Champions para ver
  .statistic = estadística
  .statistic-description = La estadística de UHC Champions para proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
vampirez-project = proyecto
  ...
  .mode-description = El modo de VampireZ para ver
  .statistic = estadística
  .statistic-description = La estadística de VampireZ para proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
walls-project = proyecto
  ...
  .mode-description = El modo de The Walls para ver
  .statistic = estadística
  .statistic-description = La estadística de The Walls para proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar
...
warlords-project = proyecto
  ...
  .mode-description = El modo de Warlords que deseas ver
  .statistic = estadística
  .statistic-description = La estadística de Warlords que deseas proyectar
  .value = valor
...
woolwars-from = desde
  ...
  .mode-description = El modo de Wool Wars que deseas ver
  .time = tiempo
  .time-description = La cantidad de tiempo que deseas retroceder (1h 12m 5s)
...
woolwars-project = proyecto
  ...
  .mode-description = El modo de Wool Wars que deseas ver
  .statistic = estadística
  .statistic-description = La estadística de Wool Wars que deseas proyectar
  .value = valor
  .value-description = El valor de la estadística que deseas proyectar
...
arcade-compare = comparar
  .description = Compara las estadísticas de Arcade de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
...
arena-compare = comparar
  .description = Compara las estadísticas de Arena de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
...
bedwars-compare = comparar
  .description = Compara las estadísticas de Bed Wars de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
...
blitz-compare = comparar
  .description = Compara las estadísticas de Blitz Survival Games de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
...
buildbattle-compare = comparar
  .description = Compara las estadísticas de Build Battle de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
...
copsandcrims-compare = comparar
  .description = Compara las estadísticas de Cops and Crims de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
...
duels-compare = comparar
  .description = Compara las estadísticas de Duels de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
  .mode = modo
  .mode-description = El modo de Duels para ver

megawalls-compare = comparar
  .description = Compara las estadísticas de Mega Walls de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
...
murdermystery-compare = comparar
  .description = Compara las estadísticas de Murder Mystery de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
...
paintball-compare = comparar
  .description = Compara las estadísticas de Paintball de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
...
pit-compare = comparar
  .description = Compara las estadísticas de The Pit de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
...
quake-compare = comparar
  .description = Compara las estadísticas de Quakecraft de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
...
skywars-compare = comparar
  .description = Compara las estadísticas de SkyWars de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
  .mode = modo
  .mode-description = El modo de SkyWars para ver

smash-compare = comparar
  .description = Compara las estadísticas de Smash Heroes de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
  .mode = modo
  .mode-description = El modo de Smash Heroes para ver

speeduhc-compare = comparar
  .description = Compara las estadísticas de SpeedUHC de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
  .mode = modo
  .mode-description = El modo de SpeedUHC para ver

tntgames-compare = comparar
  .description = Compara las estadísticas de TNT Games de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
  .mode = modo
  .mode-description = El modo de TNT Games para ver

turbokartracers-compare = comparar
  .description = Compara las estadísticas de Turbo Kart Racers de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
  .mode = modo
  .mode-description = El modo de Turbo Kart Racers para ver

uhc-compare = comparar
  .description = Compara las estadísticas de UHC Champions de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
...
vampirez-compare = comparar
  .description = Compara las estadísticas de VampireZ de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
...
walls-compare = comparar
  .description = Compara las estadísticas de The Walls de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
...
warlords-compare = comparar
  .description = Compara las estadísticas de Warlords de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
...
woolwars-compare = comparar
  .description = Compara las estadísticas de Wool Wars de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar con
...
arcade-at = en
  .description = Mostrar las estadísticas de Arcade de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
  .mode = modo
  .mode-description = El modo de Arcade a visualizar

arena-at = en
  .description = Mostrar las estadísticas de Arena de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
  .mode = modo
  .mode-description = El modo de Arena a visualizar

bedwars-at = en
  .description = Mostrar las estadísticas de Bed Wars de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
  .mode = modo
  .mode-description = El modo de Bed Wars a visualizar

blitz-at = en
  .description = Mostrar las estadísticas de Blitz Survival Games de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
  .mode = modo
  .mode-description = El modo de Blitz Survival Games a visualizar

buildbattle-at = en
  .description = Mostrar las estadísticas de Build Battle de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
  .mode = modo
  .mode-description = El modo de Build Battle a visualizar

copsandcrims-at = en
  .description = Mostrar las estadísticas de Cops and Crims de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
...
duels-at = en
  .description = Mostrar las estadísticas de Duels de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
...
megawalls-at = en
  .description = Mostrar las estadísticas de Mega Walls de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
...
murdermystery-at = en
  .description = Mostrar las estadísticas de Murder Mystery de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
  .mode = modo
  .mode-description = El modo de Murder Mystery a visualizar

paintball-at = en
  .description = Mostrar las estadísticas de Paintball de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
  .mode = modo
  .mode-description = El modo de Paintball a visualizar

pit-at = en
  .description = Mostrar las estadísticas de The Pit de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
  .mode = modo
  .mode-description = El modo de The Pit a visualizar

quake-at = en
  .description = Mostrar las estadísticas de Quakecraft de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
...
skywars-at = en
  .description = Mostrar las estadísticas de SkyWars de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
...
smash-at = en
  .description = Mostrar las estadísticas de Smash Heroes de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
...
speeduhc-at = en
  .description = Mostrar las estadísticas de SpeedUHC de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
...
tntgames-at = en
  .description = Mostrar las estadísticas de TNT Games de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
  .mode = modo
  .mode-description = El modo de TNT Games a visualizar

turbokartracers-at = en
  .description = Mostrar las estadísticas de Turbo Kart Racers de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
  .mode = modo
  .mode-description = El modo de Turbo Kart Racers a visualizar

uhc-at = en
  .description = Mostrar las estadísticas de UHC Champions de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
  .mode = modo
  .mode-description = El modo de UHC Champions a visualizar

vampirez-at = en
  .description = Mostrar las estadísticas de VampireZ de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
  .mode = modo
  .mode-description = El modo de VampireZ a visualizar

walls-at = en
  .description = Mostrar las estadísticas de The Walls de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
  .mode = modo
  .mode-description = El modo de The Walls a visualizar

warlords-at = en
  .description = Mostrar las estadísticas de Warlords de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
  .mode = modo
  .mode-description = El modo de Warlords a visualizar

woolwars-at = en
  .description = Mostrar las estadísticas de Wool Wars de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
  .mode = modo
  .mode-description = El modo de Wool Wars a visualizar

guild-at = en
  .description = Mostrar las estadísticas de un gremio en un momento específico
  .name = nombre
  .name-description = El nombre del gremio a visualizar
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo para retroceder (1h 12m 5s)
...
error-session-already-exists = Ya has creado una sesión con el nombre proporcionado.
...
session-create = crear
  ...
  .name = nombre
  .name-description = El nombre de la sesión
...
fishing-general = general
  .description = Ver estadísticas de pesca
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .mode = modo
  .mode-description = El modo de pesca a ver

fishing-from = desde
  .description = Ver el desarrollo de estadísticas de pesca desde un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .mode = modo
  .mode-description = El modo de pesca a ver
...
fishing-history = historial
  .description = Ver el desarrollo de estadísticas de pesca a lo largo del tiempo
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .mode = modo
  .mode-description = El modo de pesca a ver

fishing-project = proyecto
  .description = Proyectar estadísticas de pesca hacia el futuro
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .mode = modo
  .mode-description = El modo de pesca a ver
  .statistic = estadística
  .statistic-description = La estadística de pesca a proyectar
  .value = valor
  .value-description = El valor de la estadística a proyectar

fishing-daily = diario
  .description = Ver el desarrollo de estadísticas de pesca en el último día
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .mode = modo
  .mode-description = El modo de pesca a ver
...
fishing-weekly = semanal
  .description = Ver el desarrollo de estadísticas de pesca en la última semana
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .mode = modo
  .mode-description = El modo de pesca a ver

fishing-monthly = mensual
  .description = Ver el desarrollo de estadísticas de pesca en el último mes
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .mode = modo
  .mode-description = El modo de pesca a ver

fishing-session = sesión
  .description = Mostrar la progresión de pesca de un jugador desde el inicio de la sesión
  .session = sesión
  .session-description = Un ID de sesión
  .mode = modo
  .mode-description = El modo de pesca a ver
...
fishing-at = en
  .description = Mostrar las estadísticas de pesca de un jugador en un momento específico
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
  .time = tiempo
  .time-description = La cantidad de tiempo a retroceder (1h 12m 5s)
...
fishing-compare = comparar
  .description = Comparar las estadísticas de pesca de dos jugadores
  .from = desde
  .from-description = Jugador de Minecraft
  .to = a
  .to-description = Jugador de Minecraft para comparar
  .mode = modo
  .mode-description = El modo de pesca a ver
...
parkour = parkour
  .description = Ver estadísticas de Parkour
  .player = jugador
  .player-description = Jugador de Minecraft o sesión
